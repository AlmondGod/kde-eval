...
kde1 = GHBE(points, tau, epsilon, gaussian_fun)
...
for i in i_s:
    ...
    hbe_density = kde1.AMR(query)
    hbe_duration = time.time() - hbe_start_time
    hbe_error = np.abs(hbe_density - true_density_us) / true_density_us
    ...
    #     f.write(f"true density: {true_density_us}, {true_density_us}\n")
